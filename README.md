run.py runs the sim. The logic is all in Sim.py. Create_decks plugs in random decks of cards into the game. The simulation plays by the standard rules of blackjack.
